                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-danger btn-sm pull-right"
                             ...
                             <a href="{{route('master.details',['type' => strtolower($masterName), 'id'=>$master->id])}}" class="btn btn-primary btn-sm pull-right">
                                 Edit
            ...
            <div class="modal-content">
                ...
                <form action="{{route('master.destroy')}}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="type" id="type" value="{{$masterName}}">
                    </div>
